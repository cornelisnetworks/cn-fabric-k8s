...
type Manager interface {
	CreateIpoibLink(conf *NetConf, ifName string, netns ns.NetNS, containerID string) (*current.Interface, error)
	RemoveIpoibLink(ifName string, netns ns.NetNS) error
	CleanupHostNamespace(ifName string, containerID string) error
}
